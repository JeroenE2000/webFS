                    ...
                    <tbody>
                        ...
                        <tr>
                            <form id="update-categorie{{$c->id}}" method="POST">
                                ...
                                @method('PUT')
                                <td>
                                    <input type="text" name="title" id="title{{$c->id}}" value="{{$c->name}}" class="form-control" required/>
                                </td>
            ...
            <div class="card-body">
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <table class="table" id="multiForm">
                        ...
                        <tbody>
                        <tr>
                            <td><input type="text" name="name" id="addCategorie" class="form-control" required/></td>
                        </tr>
                        </tbody>
                        <tfoot>
                            <tr>
